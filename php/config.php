...
class QueryType {
  ...
  public static $SELECT = QUERY_SELECT;
  public static $INSERT = QUERY_INSERT;
  public static $UPDATE = QUERY_UPDATE;
  public static $DELETE = QUERY_DELETE;
...
class QueryBuilder
{
  ...
  public function __construct(String $type, String $table, array $post_result, array $required = [], array $conditions = [], array $specials = [])
  {
    ...
    switch ($type) {
      case "SELECT":
        QueryBuilder::select($table, $required, $conditions, $specials);
        break;
      case "INSERT":
        QueryBuilder::insert($table, $post_result, $required);
        break;
      case "UPDATE":
        QueryBuilder::update($table, $post_result, $required, $conditions);
        break;
      case "DELETE":
        QueryBuilder::delete($table, $post_result, $conditions);
        break;
      default:
        break;
    }
