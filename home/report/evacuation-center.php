      ...
      <div class="content-wrapper">
         ...
         <div class="content-header">
            <div class="container-fluid">
               <div class="row mb-2">
                  <div class="col-sm-6">
                     <h1 class="m-0" style="color: rgb(232, 193, 33);"><span class="fa fa-chart-bar"></span> List of
                        Evacuees</h1>
                  </div>
                  <!-- /.col -->
                  <div class="col-sm-6">
         ...
         <section class="content">
            <div class="container-fluid">
               <div class="card card-info p-3">
                  ...
                  <div class="col-md-12">
                     <table id="evacuee" class="table table-bordered table-hover">
                        <thead>
                           <tr>
                              <th>#</th>
                              <th>Name</th>
...
<script>
   async function load_all_evacuess(){
      await fetch(BASE_URL + 'php/report_by_evacuee.php')
      ...
      .then(response => {
         ...
         for(let row of result){
            ...
            tbody += `<tr>`;
            tbody += `<td>${row.id}</td>`;
            tbody += `<td>${row.lname}, ${row.fname} ${row.mname} </td>`;
         ...
         tbody += `</tbody>`;
         document.querySelector('table#evacuee > tbody').innerHTML = tbody;
         $("#evacuee").DataTable();
      });
   }
