...
<body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div class="container-fluid">
               <div class="row">
                  <div class="col-12 col-md-4 col-lg-4 col-xl-4">
                     <div class="card">
                        <div class="card-body">
                           <table id="dataTable" class="table table-bordered mytable">
                              <thead>
                                 <tr>
                                    <th>Center</th>
                                    <th>Number</th>
   ...
   <script>
      function load_chart(keys = null, values = null) {

         // Bar Chart

         var barChartData = {
            labels: keys === null ? ["Center 1", "Center 2", "Center 3", "Center 4", "Center 5"] : keys,
            datasets: [{
               label: 'Evacuees',
               backgroundColor: 'rgb(79,129,189)',
               borderColor: 'rgba(0, 158, 251, 1)',
               borderWidth: 1,
               data: values === null ? [25, 15, 25, 30, 13] : values
            }]
         };
...
<script>
   fetch(BASE_URL + 'php/report_by_center.php')
