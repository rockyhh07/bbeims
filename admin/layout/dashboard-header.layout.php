...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: rgb(68, 126, 52);">
      <!-- Brand Logo -->
      <a href="<?= Core::base_url() ?>" class="brand-link animated swing">
        <img src="<?= Core::base_url() ?>/asset/img/logo2.png" alt="DSMS Logo" width="200" style="margin-top: -20px;margin-bottom: -60px;">
      </a>
      <!-- Sidebar -->
      <div class="sidebar">
        <!-- Sidebar Menu -->
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item">
              <a href="<?= Core::base_url() ?>" class="nav-link">
            ...
            <li class="nav-item">
              <a href="<?= Core::base_url() ?>/admin/manage/incident.php" class="nav-link">
